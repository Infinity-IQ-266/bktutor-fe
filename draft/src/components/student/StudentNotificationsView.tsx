import { Bell, CheckCheck, Trash2, Calendar, FileText, MessageSquare, AlertCircle } from 'lucide-react';
...
export default function StudentNotificationsView({ userData }: StudentNotificationsViewProps) {
    ...
    <div className="p-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Stay updated with your tutoring activities</p>
        </div>
        <Button 
          variant="outline"
